...
As of *V0.5.2*, five major waves are complete and released (see `CHANGELOG.md` for full detail):
...
not verified against live docs, no Sammelbestätigung aggregation, no full GoBD tamper-evidence/TSE,
federation not yet built) are tracked in `CHANGELOG.md`. See
link:docs/architecture/domain-model.adoc[domain model documentation] (currently covers the V0.1.5
Contributions/Documents/Communication slice — not yet updated for V0.2+) and `CLAUDE.md` for
further detail.
