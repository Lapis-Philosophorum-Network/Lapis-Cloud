 ...
 * core of Meritokratische Abstimmungen (V0.2.3). No DB access anywhere in this file (matches
...
class AbstimmungVickreyTest :
    FunSpec({
        ...
        test("zero balance / weight-manipulation attempt: a member cannot spoof a second ballot for more voting weight") {
            ...
            // prevention lives in GovernanceService.castStimme's upsert + the DB unique
